...
public class FastDatasourceServletAction extends RenderPageServletAction {
    ...
    private static final Logger log = LoggerFactory.getLogger(FastDatasourceServletAction.class);

    public FastDatasourceServletAction() {
        System.out.println("FastDatasourceServletAction");
    }
    ...
    public void buildFields(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(StringUtils.isNotEmpty(isPage) && isPage.equals("true")){
