...
public class FastExportExcelServicetAction extends BaseServletAction {
    ...
    private static final Logger log = LoggerFactory.getLogger(FastExportExcelServicetAction.class);
    ...
    public void buildExcel(HttpServletRequest req, HttpServletResponse resp,
        ...
        // J2eeFAST 整合系统 支持多租户模式 TODO
        parameters.put("tenantId", SecurityUtils.getCurrentSessionInfo().getLoginHomeCompanyId());
        ...
        if(file.equals(PREVIEW_KEY)){
            ...
            //数据权限
            parameters.put("sqlFilter",UreportUtils.getSQLFilter(file));
