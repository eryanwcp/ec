...
public class FastHtmlShareviewServletAction extends RenderPageServletAction {
    ...
    private static final Logger log = LoggerFactory.getLogger(FastHtmlShareviewServletAction.class);
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(method!=null){
            ...
            try{
                ...
                errCode = String.valueOf(e.getCode());
            }catch(Exception ex){
    ...
    public void loadPrintPages(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String file = "";
        String password = "";
        String code = com.eryansky.utils.CacheUtils.get(__surl);
        ...
        if(StringUtils.isEmpty(__pass) || !__pass.equals(password)){
            ref.put("code","B00001");
            ref.put("msg","访问密码错误!");
            writeObjectToJson(resp, ref);
            return;
...
//                .getPrincipal()).getName());
    ...
    public void verify(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(StringUtils.isNotBlank(pageIndex) &&
                !pageIndex.equals("0") &&
                UreportUtils.isFunc(_file,"page")){
