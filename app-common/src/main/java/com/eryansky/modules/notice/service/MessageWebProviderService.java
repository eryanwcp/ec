 ...
 */
@Component
public class MessageWebProviderService implements MessageWebAPI {

    private static final Logger logger = LoggerFactory.getLogger(MessageWebProviderService.class);
