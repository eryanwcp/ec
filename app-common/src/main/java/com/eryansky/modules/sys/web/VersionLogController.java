...
public class VersionLogController extends SimpleController {
    ...
    public static Result upload(@RequestParam(value = "uploadFile", required = false) MultipartFile multipartFile) {
        ...
        try {
            ...
            file = DiskUtils.saveSystemFile(VersionLog.FOLDER_VERSIONLOG, FolderType.NORMAL.getValue(), sessionInfo.getUserId(), multipartFile,DiskUtils.getMultipartOriginalFilename(multipartFile));
