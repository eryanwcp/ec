...
public class PostController extends SimpleController {
    ...
    @Logging(value = "岗位管理-保存岗位",data = "#JsonMapper.toJson(#model)", logType = LogType.operate)
     ...
     */
    @RequiresPermissions("sys:post:edit")
    @Logging(value = "岗位管理-删除岗位",data = "#JsonMapper.toJson(#ids)", logType = LogType.operate)
    ...
    @Logging(value = "岗位管理-添加关联用户",remark = "#model.id",data = "#JsonMapper.toJson(#userIds)", logType = LogType.operate)
     ...
     */
    @RequiresPermissions(logical = Logical.OR,value = {"sys:post:edit","sys:user:post:edit","sys:post:user:edit"})
    @Logging(value = "岗位管理-移除关联用户",remark = "#model.id",data = "#JsonMapper.toJson(#userIds)", logType = LogType.operate)
