...
<head>
	...
	<script type="text/template" id="systemList">
		<table class="table table-striped table-bordered table-condensed">
			...
			<tr><td>JVM内存最大可用</td><td>{{jvm.max}} M</td></tr>
			<tr><td>JVM内存占用</td><td>{{jvm.total}} M</td></tr>
			<tr><td>JVM内存已使用</td><td>{{jvm.used}} M</td></tr>
			<tr><td>JVM内存使用率</td><td>{{jvm.usage}} %</td></tr>
			<tr><td>JVM内存空闲</td><td>{{jvm.free}} M</td></tr>
