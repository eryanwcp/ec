...
public class SearchFormData {
	private String html;
	private String js;
	private String searchFormDataStyle;
	...
	public String getSearchFormDataStyle() {
		return this.searchFormDataStyle;
	}

	public void setSearchFormDataStyle(String searchFormDataStyle) {
		this.searchFormDataStyle = searchFormDataStyle;
	}
}
