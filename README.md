...
EC 是一个基于 **Spring Boot 2.7.18 构建的企业级应用开发基础平台，15年以上长期维护经验。该项目整合了企业日常办公所需的核心功能模块，包括用户与组织管理、细粒度权限控制（RBAC）、云盘文件管理、消息通知系统、RPC 远程调用、单点登录以及丰富的基础开发辅助工具。
...
*   **系统监控**: 服务器基本信息监控、日志控制台、缓存管理、会话管理等。
